...
const ToDoList = () => {
    ...
    return (
        <div className="h-[70%] min-w-[30%] desktop:w-[40%] desktop:h-[80%] laptop:w-[30%] laptop:h-[80%] phone:w-full phone:h-full bg-white rounded-xl shadow-2xl p-5 flex flex-col">
